...
class TemplateTests {
    ...
    @Test
    void given_a_text_with_expressions_when_evaluating_then_returns_the_text_with_substituted_values() {
        var data = Map.of("firstName", "Jan", "lastName", "Kowalski");
        var template = new Template(TEXT_WITH_EXPRESSIONS);
        assertEquals(TEXT_WITHOUT_EXPRESSIONS, template.evaluate(data));
    }
    ...
    @Test
    void given_a_text_with_expressions_when_evaluating_without_with_non_alphanumeric_values_then_throws_an_exception() {
